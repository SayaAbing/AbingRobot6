...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="abing_"),
...
def Abing_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="abing_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="abing_back"),
                    ],
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="abing_"),
                    ],
                ]
            ),
        )
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/SayaAbing/AbingRobot)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/SayaAbing/AbingRobot/blob/master/LICENSE).
